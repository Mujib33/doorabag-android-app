...
class ChimneyCategorySheet extends StatelessWidget {
  final double height;
  final String cityLabel;
  final VoidCallback onClose;

  const ChimneyCategorySheet({
    super.key,
  ...
  // ✅ ONLY META (subtitle + image + basePrice fallback) — AC pattern
  Map<String, Map<String, dynamic>> get _cmMeta => {
        'Chimney Check-up': {
          'subtitle': 'Noise/suction/power diagnosis',
          'basePrice': 199,
          'image': 'assets/icons/chimney repair.webp',
        },
        'Chimney Installation': {
          'subtitle': 'Wall mount + duct fitting',
          'basePrice': 699,
          'image': 'assets/icons/chimney isntallation.png',
        },
        'Chimney Uninstallation': {
          'subtitle': 'Safe removal & sealing',
          'basePrice': 399,
          'image': 'assets/icons/chimney uninstallation.png',
        },
        'Chimney Deep Cleaning': {
          'subtitle': 'Motor/mesh/hood cleaning',
          'basePrice': 899,
          'image': 'assets/icons/chimney deep cleaning.png',
        },
        'Filter Checkup': {
          'subtitle': 'Baffle/mesh filter change',
          'basePrice': 499,
          'image': 'assets/icons/chimney filter change.png',
        },
      };
                                  ...
                                  return Column(
                                    children:
                                      ...
                                      final String image = (meta['image'] ??
                                              'assets/icons/chimney repair.webp')
                                          .toString();
                                      final int basePrice =
                                      ...
                                      return Padding(
                                        ...
                                        child: _ServiceCard(
                                          ...
                                          onAdd: () {
                                            ...
                                            debugPrint(
                                                'ADD -> {identityHashCode(cart)} @Chimney');
                        ...
                        SliverToBoxAdapter(
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                Text(
                                  'Chimney Spare Parts Standard Rate Card — $city',
                                  textAlign: TextAlign.center,
                                  style: const TextStyle(
                                    fontSize: 16,
                                  ...
                                  child: OutlinedButton(
                                    onPressed: () {
                                      final url = Uri.parse(
                                        ...
                                        '?category=${Uri.encodeComponent('Chimney')}'
                          ...
                          Container(
                            ...
                            child: const Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 8),
                                Text(
                                  'Approx. 60–120 mins work • Professional chimney specialist • Standard safety protocols followed',
                                  style: TextStyle(
                                    fontSize: 13,
                                    height: 1.4,
                                    color: Colors.black54,
                          ...
                          Container(
                            ...
                            child: const Column(
                              ...
                              children: [
                                ...
                                _BulletPoint(
                                    'Technician checks suction, noise, filters and internal parts.'),
                                _BulletPoint(
    ...
    if (isNet) {
      return Image.network(
        ...
        errorBuilder: (_, __, ___) =>
            Image.asset('assets/icons/chimney repair.webp', fit: BoxFit.cover),
      );
    }
    return Image.asset(
      image,
