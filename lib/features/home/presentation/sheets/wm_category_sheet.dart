...
class WmCategorySheet extends StatelessWidget {
  final double height;
  final String cityLabel;
  final VoidCallback onClose;

  const WmCategorySheet({
    super.key,
  ...
  Map<String, Map<String, dynamic>> get _wmMeta => {
        'Semi-automatic Check-up & Repair': {
          'subtitle': 'Basic diagnosis & check-up',
          'basePrice': 199,
          'image': 'assets/photos/semi automatic.webp',
        },
        'Fully-automatic Check-up & Repair (Top load)': {
          'subtitle': 'Complete check-up for top load',
          'basePrice': 199,
          'image': 'assets/photos/top load.webp',
        },
        'Fully-automatic Check-up & Repair (Front load)': {
          'subtitle': 'Comprehensive check-up for front load',
          'basePrice': 199,
          'image': 'assets/photos/front load.webp',
        },
        'Washing Machine Installation': {
          'subtitle': 'Expert installation service',
          'basePrice': 349,
          'image': 'assets/icons/washing machine isntallation.png',
        },
        'Washing Machine Uninstallation': {
          'subtitle': 'Safe & secure removal',
          'basePrice': 349,
          'image': 'assets/icons/washing machine isntallation.png',
        },
        'Fully-automatic (Top load) Chemical Drum Servicing': {
          'subtitle': 'Deep chemical cleaning for top load',
          'basePrice': 1250,
          'image': 'assets/icons/top load servicing.png',
        },
        'Fully-automatic (Front load) Chemical Drum Servicing': {
          'subtitle': 'Deep chemical cleaning for front load',
          'basePrice': 1450,
          'image': 'assets/icons/front load servicing.png',
        },
      };
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Washing Machine Repair & Services in ${cityLabel.trim()}',
                                    ...
                                    children:
                                      ...
                                      return Padding(
                                        ...
                                        child: _ServiceCard(
                                          ...
                                          subtitle: subtitle,
                                          price: finalPrice, // ✅ backend price
                                          image: image,
                                          onAdd: () {
                                            final cart = CartService.instance;
                                            debugPrint(
                                                'ADD -> {identityHashCode(cart)} @Washing Machine');
                        ...
                        SliverToBoxAdapter(
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                Text(
                                  'Washing Machine Spare Parts Standard Rate Card — ${cityLabel.trim()}',
                                  textAlign: TextAlign.center,
                                  style: const TextStyle(
                                    fontSize: 16,
                                ...
                                SizedBox(
                                  ...
                                  child: OutlinedButton(
                                    onPressed: () {
                                      final url = Uri.parse(
                                        'https://doorabag.in/standard_rate_card.php'
                                        '?category=${Uri.encodeComponent('Washing Machine')}'
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) {
        ...
        return SafeArea(
          top: false,
          child: Padding(
            padding: EdgeInsets.only(left: 12, right: 12, bottom: bottom + 8),
            child: Column(
                          ...
                          Container(
                            ...
                            child: const Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 8),
                                Text(
                                  'Approx. 45–90 mins work • Washing machine specialist • Standard safety protocols followed',
                                  style: TextStyle(
                                    fontSize: 13,
                                    height: 1.4,
                                    color: Colors.black54,
                          ...
                          Container(
                            ...
                            child: const Column(
                              ...
                              children: [
                                ...
                                _BulletPoint(
                                    'Technician checks the washing machine and confirms the issue.'),
                                _BulletPoint(
