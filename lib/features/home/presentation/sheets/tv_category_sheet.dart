...
class TvCategorySheet extends StatelessWidget {
  final double height;
  final String cityLabel;
  final VoidCallback onClose;

  const TvCategorySheet({
    super.key,
  ...
  // ✅ Only META locally (subtitle + image + basePrice fallback) — AC pattern
  Map<String, Map<String, dynamic>> get _tvMeta => {
        'LED/TV Check-up': {
          'subtitle': 'Diagnosis for display / power / sound issues',
          'basePrice': 199,
          'image': 'assets/icons/tvcheckup.png',
        },
        'No Power / Auto Off': {
          'subtitle': 'Power board & connector checks',
          'basePrice': 199,
          'image': 'assets/icons/nopower.png',
        },
        'No Display / Lines on Screen': {
          'subtitle': 'Panel / T-Con / LVDS diagnosis',
          'basePrice': 199,
          'image': 'assets/icons/screenissue.png',
        },
        'No Sound / Distorted Audio': {
          'subtitle': 'Speaker / amp / board inspection',
          'basePrice': 199,
          'image': 'assets/icons/tvcheckup.png',
        },
        'Wall Mount Installation': {
          'subtitle': 'Standard LED TV wall mount',
          'basePrice': 449,
          'image': 'assets/icons/tvinstallation.png',
        },
      };
                ...
                Expanded(
                  child: NotificationListener<ScrollNotification>(
                    ...
                    child: CustomScrollView(
                      ...
                      slivers: [
                        // ✅ AC-style: backend services list
                        SliverPadding(
                        ...
                        SliverToBoxAdapter(
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                Text(
                                  'TV Spare Parts Standard Rate Card — $city',
                                  textAlign: TextAlign.center,
                                  style: const TextStyle(
                                    fontSize: 16,
                                  ...
                                  child: OutlinedButton(
                                    onPressed: () {
                                      final url = Uri.parse(
                                        ...
                                        '?category=${Uri.encodeComponent('TV')}'
                          ...
                          Container(
                            ...
                            child: const Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 8),
                                Text(
                                  'Approx. 45–90 mins work • LED / TV specialist • Standard safety protocols followed',
                                  style: TextStyle(
                                    fontSize: 13,
                                    height: 1.4,
                                    color: Colors.black54,
                          ...
                          Container(
                            ...
                            child: const Column(
                              ...
                              children: [
                                ...
                                _BulletPoint(
                                    'Technician checks the TV and confirms the issue.'),
                                _BulletPoint(
    ...
    if (isNet) {
      return Image.network(
        ...
        errorBuilder: (_, __, ___) =>
            Image.asset('assets/icons/tv.png', fit: BoxFit.cover),
      );
    }
