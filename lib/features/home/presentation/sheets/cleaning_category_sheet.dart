import 'package:doora_app/features/cart/cart_service.dart'; // ✅ ALWAYS this path
...
import 'package:doora_app/features/home/services/booking_rates_service.dart'; // ✅ NEW

class CleaningCategorySheet extends StatelessWidget {
  final double height;
  final String cityLabel;
  final VoidCallback onClose;

  const CleaningCategorySheet({
    super.key,
  ...
  // ✅ ONLY META (subtitle + image + basePrice fallback)
  Map<String, Map<String, dynamic>> get _clMeta => {
        'Kitchen Deep Cleaning': {
          'subtitle': 'Chimney, tiles, slab & cabinets',
          'basePrice': 1299,
          'image': 'assets/icons/kitchendeep.png',
        },
        'Bathroom Deep Cleaning': {
          'subtitle': 'Floor/walls/descaling & sanitization',
          'basePrice': 799,
          'image': 'assets/icons/bathroomcleaning.png',
        },
        'Sofa Shampooing (per 5-seater)': {
          'subtitle': 'Foam shampoo + vacuum',
          'basePrice': 999,
          'image': 'assets/icons/sofashampoo.png',
        },
        'Full Home Deep Cleaning (1 BHK)': {
          'subtitle': 'Kitchen+Bathroom+Rooms+Balcony',
          'basePrice': 2499,
          'image': 'assets/icons/1bhkdeepcleaning.png',
        },
        'Full Home Deep Cleaning (2 BHK)': {
          'subtitle': 'Kitchen+2 Bath+Rooms+Balcony',
          'basePrice': 3499,
          'image': 'assets/icons/2bhkcleaning.png',
        },
      };
                ...
                Expanded(
                  child: NotificationListener<ScrollNotification>(
                    ...
                    child: CustomScrollView(
                      ...
                      slivers: [
                        // ✅ BACKEND SERVICES LIST (AC PATTERN)
                        SliverPadding(
                                      ...
                                      return Padding(
                                        ...
                                        child: _ServiceCard(
                                          ...
                                          onAdd: () {
                                            ...
                                            debugPrint(
                                                'ADD -> {identityHashCode(cart)} @Cleaning');
                        ...
                        SliverToBoxAdapter(
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                Text(
                                  'Cleaning Standard Rate Card — $city',
                                  textAlign: TextAlign.center,
                                  style: const TextStyle(
                                    fontSize: 16,
                                ...
                                SizedBox(
                                  ...
                                  child: OutlinedButton(
                                    onPressed: () {
                                      // ✅ FIX: category should be "Cleaning" (not Bathroom)
                                      final url = Uri.parse(
                                        'https://www.doorabag.in/standard_rate_card.php'
                                        '?category=${Uri.encodeComponent('Cleaning')}'
                          ...
                          Container(
                            ...
                            child: const Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 8),
                                Text(
                                  'Approx. 2–6 hours work • Professional cleaning team • Branded chemicals & machines used',
                                  style: TextStyle(
                                    fontSize: 13,
                                    height: 1.4,
                                    color: Colors.black54,
                          ...
                          Container(
                            ...
                            child: const Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 8),
                                _BulletPoint(
                                    'Doorabag verified cleaning team visits your location.'),
                                _BulletPoint(
                                    'Scope of work is explained & area is inspected before starting.'),
                                _BulletPoint(
                                    'Final estimate is shared with you before starting the work.'),
                                _BulletPoint(
                                    'Deep cleaning is completed and area is handed over after inspection.'),
                              ],
                            ),
                          ),
