...
class RefrigeratorCategorySheet extends StatelessWidget {
  final String cityLabel;
  final VoidCallback onClose;

  const RefrigeratorCategorySheet({
    super.key,
  ...
  Map<String, Map<String, dynamic>> get _fridgeMeta => {
        'Single Door Refrigerator Check-up': {
          'subtitle': 'Basic check-up for single door',
          'basePrice': 199,
          'image': 'assets/icons/singledoor.png',
        },
        'Double Door Refrigerator Check-up (non-inverter)': {
          'subtitle': 'Check-up for non-inverter double door',
          'basePrice': 199,
          'image': 'assets/icons/doubledoor.png',
        },
        'Double Door Refrigerator Check-up (inverter)': {
          'subtitle': 'Comprehensive check-up for inverter double door',
          'basePrice': 199,
          'image': 'assets/icons/inverter.png',
        },
        'Side-By-Side Door Refrigerator Check-up': {
          'subtitle': 'Check-up for side-by-side refrigerator',
          'basePrice': 199,
          'image': 'assets/icons/sbs.png',
        },
        'Single Door Refrigerator Full Servicing': {
          'subtitle': 'Deep cleaning and servicing',
          'basePrice': 749,
          'image': 'assets/icons/singledoorservice.png',
        },
        'Double Door Refrigerator Full Servicing': {
          'subtitle': 'Deep cleaning and servicing',
          'basePrice': 1049,
          'image': 'assets/icons/doubledoorservice.png',
        },
      };
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Refrigerator Repair & Services in ${cityLabel.trim()}',
                      ...
                      slivers: [
                        ...
                        SliverPadding(
                          ...
                          sliver: SliverToBoxAdapter(
                            child: FutureBuilder<List<BookingServiceRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return Column(
                                  children: List.generate(services.length, (i) {
                                    ...
                                    final meta = _fridgeMeta[s.title] ?? {};
                                    final String subtitle =
                                        (meta['subtitle'] ?? 'Service details')
                                            .toString();
                                    ...
                                    return Padding(
                                      ...
                                      child: _ServiceCard(
                                        ...
                                        onAdd: () {
                                          ...
                                          debugPrint(
                                              'ADD -> {identityHashCode(cart)} @Refrigerator');
                        ...
                        SliverToBoxAdapter(
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                Text(
                                  'Refrigerator Spare Parts Standard Rate Card — ${cityLabel.trim()}',
                                  textAlign: TextAlign.center,
                                  style: const TextStyle(
                                    fontSize: 16,
                                  ...
                                  child: OutlinedButton(
                                    onPressed: () {
                                      final url = Uri.parse(
                                        ...
                                        '?category=${Uri.encodeComponent('Refrigerator')}'
...
// ✅ same card / sheet code as your file (unchanged below)
                          ...
                          Container(
                            ...
                            child: const Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 8),
                                Text(
                                  'Approx. 45–90 mins work • Refrigerator specialist • Standard safety protocols followed',
                                  style: TextStyle(
                                    fontSize: 13,
                                    height: 1.4,
                                    color: Colors.black54,
                          ...
                          Container(
                            ...
                            child: const Column(
                              ...
                              children: [
                                ...
                                _BulletPoint(
                                    'Technician checks the refrigerator and confirms the issue.'),
                                _BulletPoint(
